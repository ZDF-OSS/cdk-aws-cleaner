...
| <code><a href="#cdk-aws-cleaner.AwsCleaner.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-aws-cleaner.AwsCleaner.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-aws-cleaner.AwsCleaner.with.parameter.mixins"></a>
